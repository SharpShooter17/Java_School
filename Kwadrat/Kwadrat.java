...
class Kwadrat {
  public static void main(String args[]){
    ...
    if (args.length != 3){
      ...
      System.out.println("Program rozwi¹zuje równanie ax^2 + bx + x.\n kolejnoœæ przyjmowanych parametrów to: a b c.");
      return;
    }
    int i = 0;
    try {
      ...
      System.out.println("Parametr numer " + i + " jest bêdny.\n Parametry musz¹… byæ liczbami rzeczywistymi.");
      return;
    }
